...
export const INSTITUTION_WORKFLOW_DEFINITIONS: WorkflowDefinitionSeed[] = [
  ...
  {
    code: 'ELECTION_CERTIFICATION',
    name: 'Election results certification',
    scope: 'INSTITUTION',
    triggerEntity: 'Election',
    steps: [
      {
        stepNumber: 1,
        name: 'Electoral committee review',
        assignedTo: { positionCode: 'DEAN' },
        slaHours: 72,
        scope: 'INSTITUTION',
      },
      {
        stepNumber: 2,
        name: 'Registrar publish approval',
        assignedTo: { positionCode: 'REG' },
        slaHours: 48,
        scope: 'INSTITUTION',
      },
  ...
  {
    code: 'MEETING_MINUTES_FILING',
    name: 'Meeting minutes registrar filing',
    scope: 'ENTITY',
    triggerEntity: 'Meeting',
    steps: [
      {
        stepNumber: 1,
        name: 'Registrar files minutes',
        assignedTo: { positionCode: 'REG' },
        slaHours: 120,
        scope: 'INSTITUTION',
      },

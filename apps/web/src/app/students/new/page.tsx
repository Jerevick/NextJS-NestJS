    ...
    return (
      <main style={{ padding: '2rem', fontFamily: 'system-ui', maxWidth: 640 }}>
        ...
        <p style={{ color: '#64748b' }}>
          Sign in with credentials that include an API access token.
        </p>
  ...
  if (!canWrite) {
    return (
      <main style={{ padding: '2rem', fontFamily: 'system-ui', maxWidth: 640 }}>
        ...
        <h1>New student</h1>
        <p style={{ color: '#64748b' }}>
          Your account does not have permission to create students.
        </p>
      </main>
    );
  }
  ...
  if (programs.length === 0) {
    return (
      <main style={{ padding: '2rem', fontFamily: 'system-ui', maxWidth: 640 }}>
        ...
        <h1>New student</h1>
        <p style={{ color: '#64748b' }}>
          No programs exist yet for this institution. Create academic structure (division →
          department → program) first.
        </p>
      </main>
    );
  }
  ...
  return (
    <main style={{ padding: '2rem', fontFamily: 'system-ui', maxWidth: 640 }}>
      ...
      <p style={{ color: '#64748b', fontSize: '0.9rem', marginBottom: '1.5rem' }}>
        Creates a user account and student record. Student number is assigned from institution
        settings.
      </p>

...
export default async function MeetingsInboxPage() {
  ...
  const res = await fetch(
    `${apiBase}/workflow/inbox?codes=${encodeURIComponent('MEETING_MINUTES_FILING')}`,
  ...
  return (
    <main style={{ padding: '2rem', fontFamily: 'system-ui', maxWidth: 900 }}>
      ...
      <h1 style={{ marginTop: 0 }}>Minutes filing inbox</h1>
      <p style={{ color: '#64748b', fontSize: '0.9rem' }}>
        Registrar filing workflow for approved meeting minutes.
      </p>
